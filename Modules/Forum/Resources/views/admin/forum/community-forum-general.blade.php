        ...
        <div class="row">
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="profile-info-block">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="card m-b-30">
                                @if($forumList->photo != '' && file_exists(public_path().'/admin_assets/forum/'.$forumList->photo))
                                <img class="card-img-top @error('photo') 'is-invalid' @enderror" src="{{ url('admin_assets/forum/'.$forumList->photo) }}" alt="Generic placeholder image">
                                @else
                                <img class="card-img-top" src="{{ asset('admin_assets/images/blog/blog-1.jpg') }}" alt='{{ __("image") }}'>
                                @endif
                                <div class="card-body">
                                ...
                                <div class="card-footer">
                                    <div class="row align-items-center">
                                        <div class="col-md-3">
                                            <div class="blog-link">
                                                <a href="{{ url('community-forums/'.$forumList->slug) }}" class="btn btn-primary-rgba">{{ __("More") }}<i class="fas fa-arrow-right ml-2"></i></a>
                                            </div>
                                        </div>
                                        <div class="col-md-9">
                                            <div class="blog-meta">
                                                <ul class="list-inline mb-0">
                                                    ...
                                                    <li class="list-inline-item">by <a href="{{url('community-forums/'.$forumList->slug)}}">{{$forumList->user->fname.' '.$forumList->user->lname}}</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                    ...
                    <!-- add new discusion section start -->
