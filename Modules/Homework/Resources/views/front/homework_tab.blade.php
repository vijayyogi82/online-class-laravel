          ...
          <div class="accordion" id="accordionExample" class="w-100 mt-2">
            ...
            @forelse($homeworks as $homework)
              ...
              <div id="headingOne{{ filter_var($homework->id) }}" class="mb-2">
                <button class="w-100 bg-scondary text-left border" type="button" data-toggle="collapse" data-target="#collapseOne_{{ filter_var($homework->id) }}" aria-expanded="true" aria-controls="collapseOne">
                  <div class="row mt-2 mb-2 ml-2 mr-2">
                    <div class="col-md-2">
                    <small>{{ filter_var($homework->title) }}</small>
                    </div>
                    <!-- homework description--> 
                    <div class="col-md-3 text-justify">
                     <small>{{ filter_var($homework->description) }}</small>
                    </div>
