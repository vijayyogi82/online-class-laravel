...
@section('title', 'Create a new class - Admin')

@section('maincontent')
<?php
$data['heading'] = 'Create Google Meeting';
$data['title'] = 'Class';
$data['title1'] = 'Create Google Meeting';
?>
    ...
    <div class="col-lg-12">
      <div class="card dashboard-card m-b-30">
        <div class="card-header">
          <h5 class="card-title">{{ __('Create a new class in google classroom') }}</h5>
		  <div>
			<div class="widgetbar">
        ...
        <form autocomplete="off" action="{{ route('googleclassroom.store') }}" method="POST" enctype="multipart/form-data">
		@csrf
          ...
          <div class="row">
            ...
            <div class="form-group col-md-6"  id="sec3_three">
              ...
              <input type="text" name="title" placeholder="Enter Class Room" class="form-control" required>
            </div>

            <div class="form-group col-md-6"  id="sec3_three">
              <label>{{ __('Class Room Agenda :') }}</label>
              <input type="text" name="cource_description" placeholder="Enter Class Agenda" class="form-control">
            </div>
            ...
            <div class="form-group col-md-6"  id="sec5_four">
				...
				<div class="input-group" id='datetimepicker1'>
					<input type="text" name="end_time"   id="time-format1" class="form-control" placeholder="dd/mm/yyyy - hh:ii aa" aria-describedby="basic-addon5" required/>
					<div class="input-group-append">
						<span class="input-group-text" id="basic-addon5"><i class="feather icon-calendar"></i></span>
					</div>
				</div>
            ...
            <div class="form-group col-md-6"  id="sec3_three">
				<label>{{ __('Timezone :') }}</label>
					<select class="select2-single form-control" name="timezone">
					  ...
					  <option value="America/Sao_Paulo">{{ __('Sao Paulos') }}</option>
