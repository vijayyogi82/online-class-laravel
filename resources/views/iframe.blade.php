		...
		<div class="row">
			...
			<div class="col-lg-3">
				<div class="class-button">
					<ul>
						<li>
							<a href="{{ route('mycourse.show') }}" class="course_btn"> <i class="fa fa-chevron-left"></i>{{ __('My Courses') }}</a>
						</li>
						<li>
							<a href="{{ route('course.content',['id' => $courses->id, 'slug' => $courses->slug ]) }}" class="course_btn"> {{ __('Course Content') }} <i class="fa fa-chevron-right"></i></a>
						</li>
					</ul>
				</div>
			</div>
