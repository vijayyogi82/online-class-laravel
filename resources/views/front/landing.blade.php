        ...
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="download-apk-side-img">
                    <img src="{{ asset('images/qr/'.$qr['demo_image']) }}" class="img-fluid" alt="">
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                ...
                <div class="download-apk-img text-center">
                    <div class="row">
                        <div class="col-lg-6 col-6">
                            ...
                            <img src="{{ asset('images/qr/'.$qr['image']) }}" class="img-fluid" alt="">
                        </div>
                        <div class="col-lg-6 col-6">
                            <h5 class="apk-heading">{{ __('Download User ') }}<br>{{ __('APK for Android') }}</h5>
                            <img src="{{ asset('images/qr/'.$qr['image2']) }}" class="img-fluid" alt="">
                        </div>
                    </div>
                </div>
            </div>
