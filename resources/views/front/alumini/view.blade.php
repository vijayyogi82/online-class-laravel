            ...
            <div class="col-lg-4 col-md-5">
                <div class="alumini-profile-block text-center">
                    <div class="alumini-profile-img">
                        ...
                        <img src="{{ asset('images/user_img/'.$alumini->user['user_img']) }}" class="img-fluid" alt="">
                    @else
                        <img src="{{ Avatar::create($alumini->user->fname)->toBase64() }}" class="img-fluid" alt="">
                    @endif                      </div>
                ...
                <div class="alumini-profile-video">
                    <div class="video-item hidden-xs">
                        ...
                        <div class="video-device">
                            @if($alumini->user['user_img'] == !NULL)
                            <img src="{{ asset('images/user_img/'.$alumini->user['user_img']) }}" class="img-fluid bg_img" alt="">
                        @else
                            <img src="{{ Avatar::create($alumini->user->fname)->toBase64() }}" class="img-fluid bg_img" alt="">
