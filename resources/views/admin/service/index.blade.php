       ...
       <div class="col-lg-12">
            <div class="card dashboard-card m-b-30">
                <div class="card-header">
                    ...
                    <div>
                      <div class="widgetbar">
                          <a href="{{url('service/create')}}" class="btn btn-primary-rgba"><i class="feather icon-plus mr-2"></i>{{ __("Add Service")}}</a>
                      </div>                        
                    </div>
                  </div>
                <div class="card-body">
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                  <img src="{{ asset('images/services/'.$data->image) }}" class="img-responsive img-circle" >
                                </td>
                                <td>{{$data->title}}</td>
                                <td>{{$data->detail}}</td> 
                               <td>
                               ...
                               <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton3">
                                        <a class="dropdown-item"   href="{{ route('service.edit',$data->id) }}"><i class="feather icon-edit mr-2"></i>{{ __("Edit")}}</a>
