              ...
              <div class="card-header">
                  ...
                  <div>
                    <div class="widgetbar">
                        ...
                        <a href="{{ url('/all/assignment') }}" class="float-right btn btn-primary-rgba mr-2"><i class="feather icon-arrow-left mr-2"></i>{{ __('Back') }}</a>
                                        ...
                                        <div class="table-responsive">
                                          <table class="table table-borderless mb-0 user-table">
                                            <tbody>
                                              ...
                                              <tr>
                                                <th scope="row" class="p-1">{{ __('CourseChapter') }} : </th>
                                                <td class="p-1"> {{ $assign->chapter->chapter_name }}</td>
                                              </tr>
                                              <tr>
                                                <th scope="row" class="p-1">{{ __('AssignmentTitle') }} : </th>
