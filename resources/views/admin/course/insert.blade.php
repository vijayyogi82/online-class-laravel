    ...
    <div class="col-lg-12">
      <div class="card dashboard-card m-b-30">
        ...
        <div class="card-body">
          <form action="{{url('course/')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <label for="exampleInputTit1e">{{ __('Instructor') }}</label>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  <label>{{ __("Also in :") }} <span class="redstar">*</span></label>
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <input type="title" class="form-control" name="title" id="exampleInputTitle" placeholder="{{ __('Enter') }} {{ __('Title') }}" value="{{ (old('title')) }}" required>
              </div>
              <div class="col-md-6">
                <label for="exampleInputSlug">{{ __('Slug') }}: <sup class="redstar">*</sup></label>
                <input pattern="[/^\S*$/]+" type="text" class="form-control" name="slug" id="exampleInputPassword1" placeholder="{{ __('Enter') }} {{ __('Slug') }}" value="{{ (old('slug')) }}" required>
              </div>
            </div>
            <br>
            ...
            <div class="row">
              <div class="col-md-6">
                <label for="exampleInputTit1e">{{ __('ShortDetail') }}: <sup class="redstar">*</sup></label>
                <textarea name="short_detail" rows="3" class="form-control" placeholder="{{ __('Enter') }} {{ __('ShortDetail') }}" required>{{ (old('short_detail')) }}</textarea>
              </div>
              <div class="col-md-6">
                <label for="exampleInputTit1e">{{ __('Requirements') }}: <sup class="redstar">*</sup></label>
                <textarea name="requirement" rows="3" class="form-control" placeholder="{{ __('Enter') }} {{ __('Requirements') }}" required>{{ (old('requirement')) }}</textarea>
              </div>
            </div>
            <br>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <label for="exampleInputSlug">{{ __('SelectTags') }}:</label>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <label>{{ __('CourseTags') }}: <span class="redstar">*</span></label>
            ...
            <div class="col-md-3">
              <label for="exampleInputDetails">{{ __('InvolvementRequest') }}:</label>
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div style="display: none;" id="document1">
              <label for="exampleInputSlug">{{ __('UploadVideo') }}:</label>
        ...
        <div class="row">
          @if(Auth::user()->role == 'instructor')
          <div class="col-md-6">
            <label class="text-dark" for="exampleInputSlug">{{ __('PreviewImage') }}: </label>
          ...
          <div class="col-md-6">
            @if(Auth::User()->role == "admin")
            <label for="Revenue">{{ __('InstructorRevenue') }}:</label>
        ...
        <div class="row">
          ...
          <div class="col-sm-3">
            <label for="exampleInputDetails">{{ __('CertificateEnable') }}:</label>
          ...
          <div class="col-sm-3">
            <label for="">{{ __('DripContent') }}: </label>
