                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="edit-user-img">
                                  <img src="{{ url('/images/feature/'.$data->image) }}"  alt="User Image" class="img-responsive image_size">
                                </div>
                                @else
                                <div class="edit-user-img">
                                  <img src="{{ asset('images/feature/'.$data->tittle)}}"  alt="User Image" class="img-responsive img-circle">
                                </div>
                                @endif
                            </div>
                            <div class="col-md-12">
