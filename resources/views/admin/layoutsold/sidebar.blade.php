        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="{{ Nav::isResource('user/course/report') }} {{ Nav::isResource('user/question/report') }} treeview">
           <a href="#">
            ...
            <ul class="treeview-menu">
              <li class="{{ Nav::isResource('admin/report/view') }}"><a href="{{url('admin/report/view')}}"><i class="flaticon-error"></i><span>{{ __('.Reported') }} Course</span></a></li>
              <li class="{{ Nav::isResource('user/question/report') }}"><a href="{{url('user/question/report')}}"><i class="flaticon-question-mark"></i><span>{{ __('Reported') }} Question</span></a></li>
            </ul>
          </li>
