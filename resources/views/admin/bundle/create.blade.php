        ...
        <div class="card-body">
          <form action="{{url('bundle/')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-md-6">
                <div class="form-group">
                  <label>{{ __('SelectCourse') }}: <span class="text-danger">*</span></label>
              ...
              <div class="col-lg-6 col-md-6">
                <div class="form-group">
                  ...
                  <small class="text-info"><i class="fa fa-question-circle"></i> {{ __('Preview image size should be 250x150') }}.</small>
                </div>
              </div>
              <div class="col-lg-6 col-md-6">
                <div class="form-group">
                  ...
                  <textarea id="short_detail" name="short_detail" rows="4" class="form-control"
                    placeholder="{{ __('Enter') }} {{ __('ShortDetail') }}"></textarea>
                </div>
              </div>
              ...
              <div class="col-lg-4 col-md-6">
                ...
                <div class="d-none" id="doabox">
                  ...
                  <br>
                  <label for="exampleInputSlug">{{ __('DiscountPrice') }}: <sup class="text-danger">*</sup></label>
                  <input type="number" min="1" class="form-control" name="discount_price" id="exampleInputPassword1" placeholder="{{ __('Enter') }} {{ __('DiscountPrice') }}"
                    value="">
                </div>
              </div>
              <div class="col-lg-4 col-md-6">
                ...
                <div class="form-group" id="duration">
                  <label for="exampleInputSlug">{{ __('BundleExpireDuration') }} </label>
