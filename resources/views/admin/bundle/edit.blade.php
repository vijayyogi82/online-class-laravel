        ...
        <div class="col-lg-12">
            <div class="card dashboard-card m-b-30">
                <div class="card-header">
                    <h5 class="card-box">{{ __('Edit') }} {{ __('Bundle') }}</h5>
                    <div class="widgetbar">
                ...
                <div class="card-body">
                    <form action="{{ route('bundle.update', $cor->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    <label for="exampleInputDetails">{{ __('ShortDetail') }}:<sup
                                            class="text-danger">*</sup></label>
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <div @class(['d-none' => $cor->type =='0']) id="doabox">
                                    ...
                                    <div>
                                        <br>
                                        <label for="exampleInputSlug">{{ __('DiscountPrice') }}: <sup
                                                class="text-danger">*</sup></label>
