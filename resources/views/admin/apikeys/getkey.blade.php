                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="text-dark">{{ __('Client Secret KEY :') }}</label>
                                                                ...
                                                                <small class="text-info"><i class="fa fa-question-circle"></i> {{ __('Client Api key') }}.</small>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <small class="text-info"><i class="fa fa-question-circle"></i> {{ __('Enter envanto mobile app purchase code') }}.</small>
                                                            </div>
                                                        </div>
