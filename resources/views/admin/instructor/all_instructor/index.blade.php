...
@section('maincontent')
<?php
$data['heading'] = 'All Instructor';
$data['title'] = 'All Instructor';
?>
      ...
      <div class="card dashboard-card m-b-30">
        <div class="card-header all-user-card-header">
          <ul class="nav nav-pills" id="pills-tab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="false">{{ __('All Instrucor') }}</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">{{ __('Pending Instuctor Request') }}</a>
            </li>
          </ul>
        </div>
        <div>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table id="datatable-buttons" class="table table-striped table-bordered">
                  ...
                  <tbody>
                    ...
                    <img @error('photo') is-invalid @enderror
                        src="{{ url('images/user_img/'.$item->user_img) }}" alt="profilephoto"
                ...
                @endif
                      ...
                      {{-- @if(isset($item->image))
                      <td><img src="{{ asset('images/user/'.$item->image)}}" class="img-responsive img-circle"></td> 
                      @endif --}}
                      <td>
                        <ul class="user-dtl-name">
                          <li><span>Name:</span> {{$item->fname}}</li>
                          <li><span>Email:</span> {{$item->email}}</li>
                          <li><span>Mobile:</span> {{$item->mobile}}</li>
                        </ul>
                      </td>
                      <td>
                        @if($item->status==1)
                                ...
                                <div class="card m-b-30">
                                  <div class="card-body">
                                    <div class="form-group col-md-12">
                                      ...
                                      <img @error('photo') is-invalid @enderror
                                          src="{{ url('images/user_img/'.$show->user_img) }}" alt="profilephoto"
                                          class="img-responsive img-circle">
                                  @else
                                  <img @error('photo') is-invalid @enderror
                                          src="{{ Avatar::create($fname)->toBase64() }}" alt="profilephoto"
                                  ...
                                  @endif
                                        {{-- <img src="{{ asset('images/user_img/'.$show->user_image) }}" class="img-circle"/> --}}
                                      </div>
                                      <div class="mt-3">
