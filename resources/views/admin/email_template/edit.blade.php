            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="type" class="form-control" required>
                        ...
                        <option value="admin_order" {{$emailTemplate->type=='admin_order'?"selected":''}}>Admin Order</option>
                        <option value="course" {{$emailTemplate->type=='course'?"selected":''}}>Course</option>
                        <option value="verification" {{$emailTemplate->type=='verification'?"selected":''}}>Verification</option>
                        <option value="offer_push" {{$emailTemplate->type=='offer_push'?"selected":''}}>Offer Push</option>
                        <option value="user_enroll" {{$emailTemplate->type=='user_enroll'?"selected":''}}>User Enroll</option>
                    </select>
                </div>
