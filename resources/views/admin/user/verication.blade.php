                    ...
                    <div class="table-responsive">
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <td>
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal{{$user->id}}">{{ __('View') }}</button>
                                ...
                                <div class="modal fade" id="exampleModal{{$user->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-info"  data-toggle="modal" data-target="#blockedModal{{$user->id}}">{{ __('Block') }}</button>
                                            <button type="button" class="btn btn-success"><a class="text-white" href="{{ url('images/user_img/'.$user->document_file) }}" download="document.png" onclick="verify({{$user->id}})">{{ __('Verify') }}</a></button>
                                        </div>
                                        </div>
                                    </div>
                                </div>
