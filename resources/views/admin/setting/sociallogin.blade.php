				...
				<div class="card-body">
					<div class="accordion accordion-outline" id="accordionoutline1">
						...
						<div class="card-header" id="headingOneoutline">
							<h2 class="mb-0">
							<button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseOneoutline1" aria-expanded="false" aria-controls="collapseOneoutline"><i class="fa fa-facebook"></i> {{ __('Click For Facebook Login Setting') }}</button>
							</h2>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="form-group">
								<label class="text-dark">{{ __('ClientID') }} :</label>
						...
						<div class="col-md-12">
							<div class="form-group">
								<label class="text-dark">{{ __('ClientSecretKey') }}:</label>
								<input id="pass_log_id1" type="password" placeholder="enter secret key" class="form-control"  name="FACEBOOK_CLIENT_SECRET" value="{{ $env_files['FACEBOOK_CLIENT_SECRET'] }}" >
						...
						<div class="col-md-12">
							<div class="form-group">
								<label class="text-dark">{{ __('CallbackURL') }} :</label>
						...
						<div class="col-md-12">
							<div class="form-group">
								<label class="text-dark" for=""><i class="fa fa-facebook-square"></i> {{ __('EnableFacebookLogin') }} :</label><br>
			...
			<div class="card m-b-30">
				<div class="card-body">
					<div class="accordion accordion-outline" id="accordionoutline2">
						...
						<div class="card-header" id="headingOneoutline">
							<h2 class="mb-0">
							<button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseOneoutline2" aria-expanded="false" aria-controls="collapseOneoutline"><i class="fa fa-google"></i> {{ __('Click For Google Login Setting') }}</button>
							</h2>
						</div>
					...
					<form class="form" action="{{ route('sl.gl') }}" method="POST" novalidate enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group">
									<label class="text-dark">{{ __('ClientID') }} :</label>
										<input type="text" placeholder="Enter Client Id" class="form-control" name="GOOGLE_CLIENT_ID" value="{{ $env_files['GOOGLE_CLIENT_ID'] }}" >
								</div>
							</div>
							<!-- ClientSecretKey -->
							<div class="col-md-12">
								<div class="form-group">
									<label class="text-dark">{{ __('ClientSecretKey') }}:</label>
									<input id="pass_log_id2" type="password" placeholder="enter secret key" class="form-control"  name="GOOGLE_CLIENT_SECRET" value="{{ $env_files['GOOGLE_CLIENT_SECRET'] }}" >
							...
							<div class="col-md-12">
								<div class="form-group">
									<label class="text-dark" for=""><i class="fa fa-google"></i> {{ __('EnableGoogleLogin') }} : </label><br>
			...
			<div class="card m-b-30">
				<div class="card-body">
					<div class="accordion accordion-outline" id="accordionoutline3">
						...
						<div class="card-header" id="headingOneoutline">
							<h2 class="mb-0">
							<button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseOneoutline3" aria-expanded="false" aria-controls="collapseOneoutline"><i class="fa fa-gitlab"></i> {{ __('Click For GitLab Login Setting') }}</button>
							</h2>
						</div>
					...
					<form class="form" action="{{ route('sl.git') }}" method="POST" novalidate enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group">
									<label class="text-dark">{{ __('ClientID') }} :</label>
									<input name="GITLAB_CLIENT_ID" type="text" placeholder="enter client ID" class="form-control" value="{{ $env_files['GITLAB_CLIENT_ID'] }}">
								</div>
							</div>
							<!-- ClientSecretKey -->
							<div class="col-md-12">
								<div class="form-group">
									<label class="text-dark">{{ __('ClientSecretKey') }}:</label>
									<input id="pass_log_id3" type="password" placeholder="enter secret key" class="form-control"  name="GITLAB_CLIENT_SECRET" value="{{ $env_files['GITLAB_CLIENT_SECRET'] }}" >
							...
							<div class="col-md-12">
								<div class="form-group">
									<label class="text-dark" for=""><i class="fa fa-gitlab"></i> {{ __('EnableGitLabLogin') }}: </label><br>
			...
			<div class="card m-b-30">
				<div class="card-body">
					<div class="accordion accordion-outline" id="accordionoutline4">
						...
						<div class="card-header" id="headingOneoutline">
							<h2 class="mb-0">
							<button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseOneoutline4" aria-expanded="false" aria-controls="collapseOneoutline"><i class="fa fa-amazon"></i> {{ __('Click For Amazon Login Setting') }}</button>
							</h2>
						</div>
					...
					<form class="form" action="{{ route('sl.amazon') }}" method="POST" novalidate enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group">
									<label class="text-dark">{{ __('ClientID') }} :</label>
									<input name="AMAZON_LOGIN_ID" type="text" placeholder="enter client ID" class="form-control" value="{{ $env_files['AMAZON_LOGIN_ID'] }}">
								</div>
							</div>
							<!-- ClientSecretKey -->
							<div class="col-md-12">
								<div class="form-group">
									<label class="text-dark">{{ __('ClientSecretKey') }}:</label>
									<input id="pass_log_id4" type="password" placeholder="enter secret key" class="form-control"  name="AMAZON_LOGIN_SECRET" value="{{ $env_files['AMAZON_LOGIN_SECRET'] }}" >
							...
							<div class="col-md-12">
								<div class="form-group">
									<label class="text-dark" for=""><i class="fa fa-amazon"></i> {{ __('EnableAmazonLogin') }}: </label><br>
			...
			<div class="card m-b-30">
				<div class="card-body">
					<div class="accordion accordion-outline" id="accordionoutline5">
						...
						<div class="card-header" id="headingOneoutline">
							<h2 class="mb-0">
							<button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseOneoutline5" aria-expanded="false" aria-controls="collapseOneoutline"><i class="fa fa-linkedin"></i> {{ __('Click For Linked Login Setting') }}</button>
							</h2>
						</div>
					...
					<form class="form" action="{{ route('sl.linkedin') }}" method="POST" novalidate enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group">
									<label class="text-dark">{{ __('ClientSecretKey') }}:</label>
									<input id="pass_log_id5" type="password" placeholder="enter secret key" class="form-control"  name="LINKEDIN_CLIENT_SECRET" value="{{ $env_files['LINKEDIN_CLIENT_SECRET'] }}" >
							...
							<div class="col-md-12">
								<div class="form-group">
									<label class="text-dark" for=""><i class="fa fa-linkedin"></i> {{ __('EnableLinkedLogin') }}: </label><br>
			...
			<div class="card m-b-30">
				<div class="card-body">
					<div class="accordion accordion-outline" id="accordionoutline6">
						...
						<div class="card-header" id="headingOneoutline">
							<h2 class="mb-0">
							<button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseOneoutline6" aria-expanded="false" aria-controls="collapseOneoutline"><i class="fa fa-twitter"></i> {{ __('Click For Twitter Login Setting') }}</button>
							</h2>
						</div>
					...
					<form class="form" action="{{ route('sl.twitter') }}" method="POST" novalidate enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group">
									<label class="text-dark">{{ __('ClientSecretKey') }}:</label>
									<input id="pass_log_id6" type="password" placeholder="enter secret key" class="form-control"  name="TWITTER_CLIENT_SECRET" value="{{ $env_files['TWITTER_CLIENT_SECRET'] }}" >
							...
							<div class="col-md-12">
								<div class="form-group">
									<label class="text-dark" for=""><i class="fa fa-twitter"></i> {{ __('EnableTwitterLogin') }}: </label><br>
